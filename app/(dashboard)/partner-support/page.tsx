    ...
    <div className="max-w-xl mx-auto space-y-5 pb-10">
      ...
      <div className="space-y-1 pt-1">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">Partner Comfort Sharing</h1>
        </div>
      ...
      {/* Privacy footer */}
      <div className="p-3.5 rounded-xl bg-muted/30 border border-border/60 text-center">
